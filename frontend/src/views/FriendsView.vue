<template>
    <div>
        <div class="flex h-screen antialiased text-gray-800">
          <div class="flex flex-row h-full w-full overflow-x-hidden bg-white rounded-lg">
            <div
            v-if="isMenuOpen"
            ...
            <button
              class="focus:outline-none text-gray-600 hover:text-gray-800"
              @click="toggleMenu"
            >
              <svg
                class="w-6 h-6"
              ...
              >
                ...
                <div class="flex flex-col mt-8">
                  <div class="mb-5 flex flex-col items-center justify-between text-xs">
                  <span class="font-bold mb-5">Crea Gruppo</span>
                  <div class="join max-w-lg">
                    <input v-model="msg" @keyup.enter="sendMessage" class="input input-bordered bg-white join-item rounded-r-full w-3/4" placeholder="Nome"/>
                    <button @click="sendMessage" class="btn join-item bg-blue-200 text-blue-500 border-none w-1/4">Crea</button>
                  </div>
                  </div>
